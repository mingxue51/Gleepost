//
//  ReflectedImageView.m
//  Gleepost
//
//  Created by Σιλουανός on 2/12/13.
...
//    if(self)
//    {
//        self.image = [self reflectedImage:self withHeight:20];
//    }
//    
//    return self;
//}
...
-(void)reflectionImageWithImage:(UIImage*)image
{
    self.image = image;
...
CGImageRef CreateGradientImage(int pixelsWide, int pixelsHigh)
{
	...
	CGContextRef gradientBitmapContext = CGBitmapContextCreate(NULL, pixelsWide, pixelsHigh,
															   8, 0, colorSpace, /*kCGImageAlphaNone*/ kCGBitmapByteOrderDefault);
