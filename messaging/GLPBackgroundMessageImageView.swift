...
/**
    Sets colour to image.

    :param: image image to be changed.
    :param: colour the colour to fill the image

    :returns: the new image
*/
func <(image: UIImage, colour: UIColor) -> UIImage
{
...
class GLPBackgroundMessageImageView: UIImageView
{
    ...
    private lazy var incomingBubbleColour: UIColor = {
        return AppearanceHelper.lightGrayStrongGleepostColour()
    }()
    ...
    private lazy var outgoingBubbleImage: UIImage = {
        var incomingBubbleImage = UIImage(named: "bubble_stroked")! < self.outgoingBubbleColour
    ...
    private lazy var incomingBubbleImage: UIImage = {
        var outgoingBubbleImage = UIImage(named: "bubble_stroked")! < self.incomingBubbleColour
    ...
    private lazy var outgoingTaillessBubbleImage: UIImage = {
        var taillessBubbleImage = UIImage(named: "bubble_stroked_tailless")! < self.outgoingBubbleColour
    ...
    private lazy var incomingTaillesBubbleImage: UIImage = {
        ...
        var incomingTaillesBubbleImage = UIImage(named: "bubble_stroked_tailless")! < self.incomingBubbleColour
