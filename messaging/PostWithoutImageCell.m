...
//TODO: Cleate a parent class and then inherit in this class and PostWithImageCell.

#import "PostWithoutImageCell.h"

@implementation PostWithoutImageCell
...
-(id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    {
       // [self createElements];
        //[self createIndividualsComponents];
...
-(void) createIndividualsComponents
{
    [self.socialPanel setBackgroundColor:[UIColor clearColor]];
    
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.contentView.frame.size.width-20, 1)];
    
    lineView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.03];
    
    [self.socialPanel addSubview:lineView];
