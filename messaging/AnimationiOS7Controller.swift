...
class AnimationiOS7Controller: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    init(imagePickerSheetController: ImagePickeriOS7SheetController, presenting: Bool) {
    ...
    private func animatePresentation(context: UIViewControllerContextTransitioning) {
        ...
        imagePickerSheetController.tableView.frame.origin.y = 0
